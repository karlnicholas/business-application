...
@Wid(widfile = "JmsWorkItem.wid", name = "JmsPublishMessages",
        ...
        defaultHandler = "mvel: new org.jbpm.process.workitem.kafka.JmsWorkItemHandler(\"bootstrapServers\", \"clientId\", \"keySerializerClass\", \"valueSerializerClass\")",
        ...
        serviceInfo = @WidService(category = "${name}", description = "${description}",
                ...
                referencesite = "https://kafka.apache.org/10/javadoc/org/apache/kafka/clients/producer/JmsProducer.html")
        ))
...
public class JmsWorkItemHandler extends AbstractLogOrThrowWorkItemHandler implements Cacheable {
    ...
    public JmsWorkItemHandler(Producer producer) {
        this.producer = producer;
    }

    public JmsWorkItemHandler(String bootstrapServers,
                                String clientId,
        ...
        producer = new JmsProducer<Long, String>(config);
    }
